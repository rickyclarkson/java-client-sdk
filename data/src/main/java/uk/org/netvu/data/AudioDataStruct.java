...
public final class AudioDataStruct
{
    ...
    /**
     * The magic number that identifies the current version of the
     * AudioDataStruct.
     */
     ...
     * 
     * @param buffer
     *        the ByteBuffer to retrieve data from for this AudioDataStruct.
    ...
    /**
     * Gets the milliseconds part of the timestamp for the data. Note that if
     * there was no AudioDataStruct in the original stream data, the constructed
     * AudioDataStruct will have 0 for this field.
     * 
    ...
    /**
     * Gets the seconds part of the timestamp for the data. Note that if there
     * was no AudioDataStruct in the original stream data, the constructed
     * AudioDataStruct will have 0 for this field.
     * 
    ...
    /**
     * Returns the offset in the ByteBuffer at which the audio data begins, in
     * bytes.
     * 
     * @return the offset in the ByteBuffer at which the audio data begins, in
     *         bytes.
     */
     ...
     * 
     * @return the version of the AudioDataStruct that is held in the
     *         ByteBuffer.
     */
    ...
    /**
     * Sets the offset in the ByteBuffer at which the audio data begins, in
     * bytes.
     * 
     * @param startOffset
