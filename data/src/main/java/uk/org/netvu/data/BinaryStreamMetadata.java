...
public final class BinaryStreamMetadata implements StreamMetadata
{
    ...
    /**
     * The length of this packet, in bytes, not including the 6-byte header that
     * a 'binary' stream packet has.
     */
    private final int length;

    /**
     * Constructs a BinaryStreamMetadata by reading the frame type, channel and
     * length from the passed-in InputStream.
     * 
     * @param input
     *        the InputStream to read metadata from.
     * @throws IOException
     *         if any I/O errors occur.
     * @throws NullPointerException
     *         if input is null.
     */
    public BinaryStreamMetadata( final InputStream input ) throws IOException
    {
    ...
    /**
     * Gets the length of this packet, in bytes, not including the 6-byte header
     * that a 'binary' stream packet has.
     * 
